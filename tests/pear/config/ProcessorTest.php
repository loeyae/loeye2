 ...
 */
class ProcessorTest extends \loeye\unit\TestCase {
    ...
    {
        $this->object = new \loeye\config\Processor;
    }
    ...
    {
        $configuration = new \loeye\config\general\RulesetConfigDefinition();
    ...
    {
        $rconfiguration = new \loeye\config\general\RulesetConfigDefinition();
        $dconfiguration = new \loeye\config\general\DeltaConfigDefinition();
